...
__webpack_require__(54).inherits(FetchError, Error);
...
module.exports = {
    ...
    'gbk': {
        type: '_dbcs',
        table: function table() {
            return __webpack_require__(7).concat(__webpack_require__(15));
        }
    },
    'xgbk': 'gbk',
    'isoir58': 'gbk',
    ...
    'big5hkscs': {
        type: '_dbcs',
        table: function table() {
            return __webpack_require__(14).concat(__webpack_require__(47));
        },
